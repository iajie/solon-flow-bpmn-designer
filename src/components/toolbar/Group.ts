...
export class Group extends AbstractToolBarMenuButton {
    ...
    connectedCallback() {
        ...
        this.tippyInstance = tippy(this.querySelector("#tippy")!, {
            ...
            appendTo: this.closest(".easy-bpmn-designer-container")!,
            placement: 'bottom',
            trigger: 'click',
            interactive: true,
            arrow: false,
    ...
    createMenuElement() {
        ...
        div.classList.add("easy-bpmn-designer-dropdown-container");
        ...
        for (let i = 0; i < this.menuButtons.length; i++) {
            ...
            item.classList.add("easy-bpmn-designer-dropdown-item");
            ...
            item.addEventListener("click", (evt) => {
                const target: HTMLDivElement = (evt.target as any).closest('.easy-bpmn-designer-menu-item');
                if (target) {
                    return;
                }
