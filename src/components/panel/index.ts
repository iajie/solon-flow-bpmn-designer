...
export const initPanelKeys = (modeler: Modeler, designer: SolonFlowBpmnDesigner, panelDom: AbstractPanel[]) => {
    try {
        ...
        panelSwitch.onCreate(modeler, designer);
        ...
        bpmnIcon.onCreate(modeler, designer);
        ...
        property.onCreate(modeler, designer);
...
export const initPanelContent = (modeler: Modeler, designer: SolonFlowBpmnDesigner, property: Property) => {
    try {
        ...
        for (let panelTab of panelTabs) {
            ...
            panelContent.initGroup(modeler, designer, panelTab.group);
